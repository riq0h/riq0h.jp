...
続く**Specify profile**はお待ちかねのデスクトップ環境選びである。遷移すると**desktop**、**minimal**、**server**、**xorg**の4項目が表示されるが、初心者は**desktop**を選ぶと失敗しにくい。GUI環境向けに推奨されているパッケージが一式すべて自動でインストールされるため、従来の**_Arch Linux Install Battle_**でしばしば起こりがちなGUIが立ち上がらない問題等に悩まされずに済むからだ。
