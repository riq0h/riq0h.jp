...
[ActivityPub実装を自作](https://riq0h.jp/2025/07/11/163822/)して一年が経った。当時はなるべくミニマルな仕様にしたかったのと、[このような](https://riq0h.jp/2023/06/19/082543/)気持ちもあって躊躇していたが、部分的に足すぶんには共存できると思い直して実装に至った。
...
当時は既存の実装系からなにを選ぶかが前提だったため、絵文字リアクションとべったり付き合うか、もしくはまったく付き合わないかのほぼ二択しかなかったが、自作の実装系を得た上にLLMの力も借りられる今時では付き合い方を柔軟に取捨選択できる。前述の記事ほど頑なに絵文字リアクションを拒絶する理由はもはやなくなったと言ってもよい。
